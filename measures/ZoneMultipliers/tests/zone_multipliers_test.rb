...
class ZoneMultipliersTest < MiniTest::Test
  ...
  def _test_measure(osm_file_or_model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, test_name)
    ...
    obj_type_exclusions = ["Node", "PortList", "SizingZone", "ZoneHVACEquipmentList", "Space", "Surface", "SpaceInfiltrationDesignFlowRate", "OtherEquipment", "People", "ZoneMixing", "ElectricEquipment", "AirTerminalSingleDuctConstantVolumeNoReheat", "AirLoopHVACReturnPlenum", "AvailabilityManagerAssignmentList", "AirLoopHVACUnitarySystem", "FanOnOff", "CoilHeatingGas", "CoilCoolingDXSingleSpeed", "AirLoopHVACZoneSplitter", "AirLoopHVACZoneMixer", "SizingSystem", "ConnectorMixer", "ConnectorSplitter", "SizingPlant", "PipeAdiabatic", "PumpVariableSpeed", "SetpointManagerScheduled", "ScheduleDay", "ScheduleRule", "ScheduleRuleset", "ElectricEquipmentDefinition", "EnergyManagementSystemGlobalVariable", "ScheduleConstant"]
