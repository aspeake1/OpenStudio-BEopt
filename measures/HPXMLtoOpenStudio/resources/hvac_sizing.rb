...
class HVACSizing
  ...
  def self.calc_slab_f_value(runner, surface, unit)
    ...
    whole_rvalue = get_feature(runner, surface, Constants.SizingInfoSlabWholeRvalue, 'double')
    return nil if whole_rvalue.nil?

    slab_thick_in = get_feature(runner, surface, Constants.SizingInfoSlabThicknessIn, 'double')
