...
class ResidentialAirflowTest < MiniTest::Test
  ...
  def test_ufbasement
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"ScheduleRuleset"=>4, "EnergyManagementSystemSubroutine"=>num_airloops, "EnergyManagementSystemProgramCallingManager"=>1+num_airloops, "EnergyManagementSystemProgram"=>2+num_airloops, "EnergyManagementSystemSensor"=>10+10*num_airloops, "EnergyManagementSystemActuator"=>5+12*num_airloops, "EnergyManagementSystemGlobalVariable"=>23*num_airloops, "AirLoopHVACReturnPlenum"=>1, "OtherEquipmentDefinition"=>10*num_airloops, "OtherEquipment"=>10*num_airloops, "ThermalZone"=>num_airloops, "ZoneMixing"=>2*num_airloops, "SpaceInfiltrationDesignFlowRate"=>3, "SpaceInfiltrationEffectiveLeakageArea"=>1, "Construction"=>1, "Space"=>num_airloops, "Material"=>1, "ElectricEquipmentDefinition"=>3, "ElectricEquipment"=>3, "SurfacePropertyConvectionCoefficients"=>6*num_airloops, "Surface"=>6*num_airloops}
    expected_values = {"res_infil_1_program"=>{"c"=>0.069658, "Cs"=>0.086238, "Cw"=>0.128435, "faneff_wh"=>0.943894, "faneff_sp"=>0.471947}, "res_nv_1_program"=>{"Cs"=>0.000179, "Cw"=>0.000282}, "res ds res fur gas asys ret air zone"=>{"RADuctVol"=>90}, "res ds res ac asys ret air zone"=>{"RADuctVol"=>90}, "res_ds_res_fur_gas_asys_lk_subrout"=>{"f_sup"=>0.136963, "f_ret"=>0.100099, "f_OA"=>0.000001}, "res_ds_res_ac_asys_lk_subrout"=>{"f_sup"=>0.136963, "f_ret"=>0.100099, "f_OA"=>0.000001}, "TerrainType"=>"Suburbs", "DuctLocation"=>"unfinished basement zone"}
  ...
  def test_fbasement
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"ScheduleRuleset"=>4, "EnergyManagementSystemSubroutine"=>num_airloops, "EnergyManagementSystemProgramCallingManager"=>1+num_airloops, "EnergyManagementSystemProgram"=>2+num_airloops, "EnergyManagementSystemSensor"=>10+10*num_airloops, "EnergyManagementSystemActuator"=>5+12*num_airloops, "EnergyManagementSystemGlobalVariable"=>23*num_airloops, "AirLoopHVACReturnPlenum"=>1, "OtherEquipmentDefinition"=>10*num_airloops, "OtherEquipment"=>10*num_airloops, "ThermalZone"=>num_airloops, "ZoneMixing"=>2*num_airloops, "SpaceInfiltrationDesignFlowRate"=>3, "SpaceInfiltrationEffectiveLeakageArea"=>1, "Construction"=>1, "Space"=>num_airloops, "Material"=>1, "ElectricEquipmentDefinition"=>3, "ElectricEquipment"=>3, "SurfacePropertyConvectionCoefficients"=>6*num_airloops, "Surface"=>6*num_airloops}
    expected_values = {"res_infil_1_program"=>{"c"=>0.046322, "Cs"=>0.084549, "Cw"=>0.128435, "faneff_wh"=>0.943894, "faneff_sp"=>0.471947}, "res_nv_1_program"=>{"Cs"=>0.000179, "Cw"=>0.000282}, "res ds res fur gas asys ret air zone"=>{"RADuctVol"=>120}, "res ds res ac asys ret air zone"=>{"RADuctVol"=>120}, "res_ds_res_fur_gas_asys_lk_subrout"=>{"f_sup"=>0.136963, "f_ret"=>0.100099, "f_OA"=>0.000001}, "res_ds_res_ac_asys_lk_subrout"=>{"f_sup"=>0.136963, "f_ret"=>0.100099, "f_OA"=>0.000001}, "TerrainType"=>"Suburbs", "DuctLocation"=>"finished basement zone"}
  ...
  def test_no_living_garage_attic_infiltration
    ...
    expected_values = {"res_infil_1_program"=>{"faneff_wh"=>0.943894, "faneff_sp"=>0.471947}, "res_nv_1_program"=>{"Cs"=>0.000179, "Cw"=>0.000282}, "res ds res fur gas asys ret air zone"=>{"RADuctVol"=>90}, "res ds res ac asys ret air zone"=>{"RADuctVol"=>90}, "res_ds_res_fur_gas_asys_lk_subrout"=>{"f_sup"=>0.136963, "f_ret"=>0.100099, "f_OA"=>0.000001}, "res_ds_res_ac_asys_lk_subrout"=>{"f_sup"=>0.136963, "f_ret"=>0.100099, "f_OA"=>0.000001}, "TerrainType"=>"Suburbs", "DuctLocation"=>"unfinished attic zone"}
