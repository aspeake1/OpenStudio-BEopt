...
class ResidentialAirflowTest < MiniTest::Test
  ...
  def test_mech_vent_cfis_duct_location_in_living
    ...
    args_hash["mech_vent_type"] = Constants.VentTypeCFIS
    expected_num_del_objects = {}
    expected_num_new_objects = { "ScheduleRuleset" => 4, "EnergyManagementSystemProgramCallingManager" => 3, "EnergyManagementSystemProgram" => 3, "EnergyManagementSystemSensor" => 12, "EnergyManagementSystemActuator" => 5, "EnergyManagementSystemGlobalVariable" => 3, "EnergyManagementSystemInternalVariable" => 2, "SpaceInfiltrationDesignFlowRate" => 2, "SpaceInfiltrationEffectiveLeakageArea" => 1, "ElectricEquipmentDefinition" => 3, "ElectricEquipment" => 3, "Material" => 1, "Construction" => 1 }
  ...
  def test_ducted_mini_split_heat_pump_cfis
    ...
    expected_values = { "res_infil_1_program" => { "c" => 0.069658, "Cs" => 0.086238, "Cw" => 0.128435, "faneff_wh" => 0.0, "faneff_sp" => 0.471947 }, "res_nv_1_program" => { "Cs" => 0.000179, "Cw" => 0.000282 }, "res ds res ms htg asys ret air zone" => { "RADuctVol" => 90 }, "res ds res ms clg asys ret air zone" => { "RADuctVol" => 90 }, "res_ds_res_ms_htg_asys_lk_subrout" => { "f_sup" => 0.136963, "f_ret" => 0.100099, "f_OA" => 0.036863 }, "res_ds_res_ms_clg_asys_lk_subrout" => { "f_sup" => 0.136963, "f_ret" => 0.100099, "f_OA" => 0.036863 }, "TerrainType" => "Suburbs", "DuctLocation" => "unfinished attic zone" }
