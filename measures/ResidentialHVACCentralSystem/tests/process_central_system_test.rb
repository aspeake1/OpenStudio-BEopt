...
class ProcessCentralSystemTest < MiniTest::Test

  def test_single_family_attached_central_system_inferred_air
    num_zones = 8
    args_hash = {}
  ...
  def test_multifamily_central_system_inferred_air
    num_zones = 8
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"PlantLoop"=>1, "PumpVariableSpeed"=>1, "BoilerHotWater"=>1, "FanConstantVolume"=>num_zones, "CoilHeatingWater"=>num_zones, "ControllerWaterCoil"=>num_zones, "CoilCoolingDXSingleSpeed"=>num_zones, "ZoneHVACPackagedTerminalAirConditioner"=>num_zones}
  ...
  def test_single_family_attached_central_system_inferred_hydronic
    num_zones = 8
    args_hash = {}
  ...
  def _test_measure(osm_file_or_model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, test_name, num_infos=0, num_warnings=0, debug=false)
    ...
    measure = ProcessCentralSystem.new
