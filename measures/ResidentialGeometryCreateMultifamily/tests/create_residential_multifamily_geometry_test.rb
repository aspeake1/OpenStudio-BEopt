...
class CreateResidentialMultifamilyGeometryTest < MiniTest::Test
  ...
  def test_uneven_units_per_floor_with_interior_corr
    ...
    expected_num_new_objects = {"BuildingUnit"=>3, "Surface"=>26, "ThermalZone"=>1+3, "Space"=>1+3, "SpaceType"=>2, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>2, "ShadingSurface"=>11, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>1, "InternalMass"=>1, "InternalMassDefinition"=>1}
  ...
  def test_two_story_double_exterior
    ...
    args_hash["balcony_depth"] = 6
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>2*4, "Surface"=>68, "ThermalZone"=>2*4, "Space"=>2*4, "SpaceType"=>1, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>14, "ShadingSurface"=>30}
    expected_values = {"FinishedFloorArea"=>900*2*4, "BuildingHeight"=>2*8, "Beds"=>3.0, "Baths"=>2.0, "NumOccupants"=>27.12, "EavesDepth"=>2}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_multiplex_right_inset
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>8*6, "Surface"=>538, "ThermalZone"=>8*6+1+1, "Space"=>8*6+1+8, "SpaceType"=>3, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>2, "ShadingSurface"=>26, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>2, "InternalMass"=>9, "InternalMassDefinition"=>2}
  ...
  def test_multiplex_left_inset
    ...
    args_hash["foundation_type"] = "unfinished basement"
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>8*6, "Surface"=>538, "ThermalZone"=>8*6+1+1, "Space"=>8*6+1+8, "SpaceType"=>3, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>50, "ShadingSurface"=>74, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>2, "InternalMass"=>9, "InternalMassDefinition"=>2}
    expected_values = {"FinishedFloorArea"=>900*8*6, "UnfinishedBasementHeight"=>8, "UnfinishedBasementFloorArea"=>6*900+3*21.77*10, "BuildingHeight"=>8+8*8, "Beds"=>3.0, "Baths"=>2.0, "NumOccupants"=>162.72, "EavesDepth"=>2}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_crawl_single_exterior
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>2*12, "Surface"=>194, "ThermalZone"=>2*12+1, "Space"=>2*12+1, "SpaceType"=>2, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>4, "ShadingSurface"=>30, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>1, "InternalMass"=>1, "InternalMassDefinition"=>1}
    expected_values = {"FinishedFloorArea"=>900*2*12, "CrawlspaceHeight"=>3, "CrawlspaceFloorArea"=>12*900, "BuildingHeight"=>3+2*8, "Beds"=>3.0, "Baths"=>2.0, "NumOccupants"=>81.36, "EavesDepth"=>2}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_crawlspace_double_loaded_corr
    ...
    args_hash["foundation_type"] = "crawlspace"
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>1*4, "Surface"=>52, "ThermalZone"=>1*4+1+1, "Space"=>1*4+1+1, "SpaceType"=>3, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>2, "ShadingSurface"=>12, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>2, "InternalMass"=>2, "InternalMassDefinition"=>2}
  ...
  def test_two_units_per_floor_with_rear_units
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>8, "Surface"=>72, "ThermalZone"=>8+1, "Space"=>12, "SpaceType"=>2, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>2, "ShadingSurface"=>10, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>1, "InternalMass"=>4, "InternalMassDefinition"=>1}
  ...
  def test_new_construction_none
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"Surface"=>18, "Space"=>3, "SpaceType"=>2, "ThermalZone"=>3, "BuildingUnit"=>2, "ShadingSurfaceGroup"=>2, "ShadingSurface"=>10, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>1, "InternalMass"=>1, "InternalMassDefinition"=>1}
  ...
  def test_new_construction_auto
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"Surface"=>18, "Space"=>3, "SpaceType"=>2, "ThermalZone"=>3, "BuildingUnit"=>2, "PeopleDefinition"=>num_finished_spaces, "People"=>num_finished_spaces, "ScheduleRuleset"=>2, "ShadingSurfaceGroup"=>2, "ShadingSurface"=>10, "Material"=>1, "MaterialPropertyMoisturePenetrationDepthSettings"=>1, "Construction"=>1, "InternalMass"=>1, "InternalMassDefinition"=>1}
    expected_values = {"FinishedFloorArea"=>900*2, "BuildingHeight"=>8, "Beds"=>3.0, "Baths"=>2.0, "NumOccupants"=>6.78, "EavesDepth"=>2}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
