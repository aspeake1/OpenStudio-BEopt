...
class ProcessConstructionsWallsSIP < OpenStudio::Measure::ModelMeasure
  ...
  def run(model, runner, user_arguments)
    ...
    # Apply constructions
    if not WallConstructions.apply_sip(walls_by_type[Constants.SurfaceTypeWallExtInsFin], 
    ...
    if not WallConstructions.apply_sip(walls_by_type[Constants.SurfaceTypeWallExtInsUnfin], 
    ...
    if not WallConstructions.apply_sip(walls_by_type[Constants.SurfaceTypeWallIntFinInsUnfin], 
