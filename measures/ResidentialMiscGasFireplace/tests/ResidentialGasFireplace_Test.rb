...
class ResidentialGasFireplaceTest < MiniTest::Test
  ...
  def test_new_construction_none1
    ...
    expected_values = {"Annual_therm"=>0, "Location"=>args_hash["location"]}
  ...
  def test_new_construction_mult_0_032
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>1.94, "Location"=>args_hash["location"]}
    _test_measure("SFD_2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_new_construction_no_scale_energy
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>60.0, "Location"=>args_hash["location"]}
    _test_measure("SFD_2000sqft_2story_FB_GRG_UA_3Beds_2Baths.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_retrofit_replace
    ...
    expected_num_new_objects = {"GasEquipmentDefinition"=>1, "GasEquipment"=>1, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>30.3, "Location"=>args_hash["location"]}
  ...
  def test_single_family_attached_new_construction
    ...
    expected_values = {"Annual_therm"=>num_units*52.0, "Location"=>args_hash["location"]}
  ...
  def test_multifamily_new_construction
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GasEquipment"=>num_units, "GasEquipmentDefinition"=>num_units, "ScheduleRuleset"=>1}
    expected_values = {"Annual_therm"=>415.97, "Location"=>args_hash["location"]}
  ...
  def _test_measure(osm_file_or_model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, num_infos=0, num_warnings=0)
    ...
    actual_values = {"Annual_therm"=>0, "Location"=>[]}
