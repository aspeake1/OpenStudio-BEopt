...
class ResidentialClothesWasherTest < MiniTest::Test
  ...
  def test_single_family_attached_new_construction
    ...
    expected_values = {"Annual_kwh"=>171.77, "HotWater_gpd"=>39.99, "Location"=>args_hash["location"]}
  ...
  def test_single_family_attached_new_construction_finished_basement
    ...
    expected_values = {"Annual_kwh"=>42.94, "HotWater_gpd"=>9.99, "Location"=>args_hash["location"]}
