...
class ResidentialPhotovoltaicsTest < MiniTest::Test
  ...
  def test_faces_north_azimuth_back_roof
    ...
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>26.57, "AzimuthAngle"=>180, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
  ...
  def test_faces_west_azimuth_back_roof
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>26.57, "AzimuthAngle"=>90, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
  ...
  def test_faces_east_azimuth_back_roof
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>26.57, "AzimuthAngle"=>270, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
  ...
  def test_faces_south_azimuth_back_roof
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>26.57, "AzimuthAngle"=>0, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
  ...
  def test_faces_north_azimuth_absolute_southwest
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>26.57, "AzimuthAngle"=>225, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_North.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_north_tilt_absolute_zero
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>0, "AzimuthAngle"=>180, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_North.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_west_tilt_absolute_zero
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>0, "AzimuthAngle"=>90, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_West.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values) 
  end
  ...
  def test_faces_east_tilt_absolute_zero
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>0, "AzimuthAngle"=>270, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_East.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_south_tilt_absolute_zero
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>0, "AzimuthAngle"=>0, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_north_tilt_absolute_thirty
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>30, "AzimuthAngle"=>180, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_North.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_west_tilt_absolute_thirty
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>30, "AzimuthAngle"=>90, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_West.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_east_tilt_absolute_thirty
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>30, "AzimuthAngle"=>270, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_East.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_south_tilt_absolute_thirty
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>30, "AzimuthAngle"=>0, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end  
  ...
  def test_faces_north_tilt_latitude_minus_15_deg
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>39.7-15, "AzimuthAngle"=>180, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_North.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_west_tilt_latitude_minus_15_deg
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>39.7-15, "AzimuthAngle"=>90, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_West.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_east_tilt_latitude_minus_15_deg
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>39.7-15, "AzimuthAngle"=>270, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver_East.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_south_tilt_latitude_minus_15_deg
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>2500, "TiltAngle"=>39.7-15, "AzimuthAngle"=>0, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values)
  end
  ...
  def test_faces_south_retrofit_size
    ...
    expected_num_new_objects = {"GeneratorPVWatts"=>1, "ElectricLoadCenterInverterPVWatts"=>1, "ElectricLoadCenterDistribution"=>1}
    expected_values = {"SystemCapacity"=>5000, "TiltAngle"=>26.57, "AzimuthAngle"=>0, "InverterEfficiency"=>0.96, "ArrayType"=>Constants.PVArrayTypeFixedRoofMount}
