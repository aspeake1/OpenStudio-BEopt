...
class UtilityBillCalculationsDetailedTest < MiniTest::Test
  ...
  def test_functionality_net_metering_custom_tariff
    ...
    args_hash["custom_tariff"] = "../../../586bda1b5457a3ef521c9605.json"
  ...
  def test_functionality_net_metering_autoselect_tariffs
    args_hash = {}
    _test_measure_functionality("SFD_Successful_EnergyPlus_Run_TMY_PV.osm", args_hash, __method__, "USA_CO_Denver_Intl_AP_725650_TMY3.epw", 35, 1)
  end
  ...
  def test_calculations_10kW_pv_net_metering_custom_tariff_retail_sellback_tiered # TODO: works with dollars=0
    args_hash = {}
    args_hash["tariff_label"] = "Custom Tariff"
    args_hash["custom_tariff"] = File.expand_path("../586bda1b5457a3ef521c9605.json", __FILE__)
    args_hash["gas_fixed"] = "8.0"
  ...
  def test_calculations_10kW_pv_net_metering_custom_tariff_tou # TODO: very close with either dollars=0/1
    args_hash = {}
    args_hash["tariff_label"] = "Custom Tariff"
    args_hash["custom_tariff"] = File.expand_path("../539f6d9eec4f024411ecb875.json", __FILE__)
    args_hash["gas_fixed"] = "8.0"
  ...
  def test_calculations_1kW_pv_net_metering_custom_tariff_tiered_tou # TODO: very close
    args_hash = {}
    args_hash["tariff_label"] = "Custom Tariff"
    args_hash["custom_tariff"] = File.expand_path("../586be0bd5457a30d661c9605.json", __FILE__)
    args_hash["gas_fixed"] = "8.0"
  ...
  def test_calculations_10kW_pv_net_metering_custom_tariff_retail_sellback_tiered_tou # TODO: close with dollars=0
    args_hash = {}
    args_hash["tariff_label"] = "Custom Tariff"
    args_hash["custom_tariff"] = File.expand_path("../586be0bd5457a30d661c9605.json", __FILE__)
    args_hash["gas_fixed"] = "8.0"
