...
class SetResidentialEPWFileTest < MiniTest::Test
  ...
  def test_change_daylight_saving
    ...
    expected_num_new_objects = {"SiteGroundTemperatureDeep"=>1, "RunPeriodControlDaylightSavingTime"=>1, "SiteGroundTemperatureBuildingSurface"=>1, "SiteWaterMainsTemperature"=>1, "WeatherFile"=>1, "ClimateZones"=>1, "Site"=>1, "YearDescription"=>1, "AdditionalProperties"=>1}
