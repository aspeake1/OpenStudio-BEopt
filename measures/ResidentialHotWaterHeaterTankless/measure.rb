...
class ResidentialHotWaterHeaterTankless < OpenStudio::Measure::ModelMeasure
    ...
    def arguments(model)
        ...
        rated_energy_factor.setDescription("Ratio of useful energy output from the water heater to the total amount of energy delivered from the water heater.")
    ...
    def run(model, runner, user_arguments)
        ...
        return false if not validate_water_heater_cycling_derate(cd, runner)
