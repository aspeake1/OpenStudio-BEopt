...
class CreateResidentialSingleFamilyAttachedGeometryTest < MiniTest::Test
  ...
  def test_fourplex_finished_hip_roof
    ...
    expected_values = {"FinishedFloorArea"=>900*4, "FinishedAtticHeight"=>8.12, "FinishedAtticFloorArea"=>300*4, "BuildingHeight"=>8+8+8.12, "FinishedBasementFloorArea"=>300*4, "FinishedBasementHeight"=>8, "Beds"=>3.0, "Baths"=>2.0, "NumOccupants"=>13.56, "EavesDepth"=>2, "NumAdiabaticSurfaces"=>0}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
