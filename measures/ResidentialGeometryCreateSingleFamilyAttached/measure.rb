...
class CreateResidentialSingleFamilyAttachedGeometry < OpenStudio::Measure::ModelMeasure
  ...
  def modeler_description
    return "Creates single-family attached geometry. Also, sets (or replaces) BuildingUnit objects that store the number of bedrooms and bathrooms associated with the model."
  end
