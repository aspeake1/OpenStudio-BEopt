...
class ProcessConstructionsFloorsTest < MiniTest::Test
  def test_uninsulated
    ...
    expected_num_new_objects = { "Material" => 6 + 2, "Construction" => 4 + 2, "InternalMass" => 4, "InternalMassDefinition" => 4, "MaterialPropertyMoisturePenetrationDepthSettings" => 2 }
  ...
  def test_retrofit_replace
    ...
    args_hash["framing_factor"] = 0.13
    args_hash["joist_height_in"] = 9.25
    expected_num_del_objects = { "Material" => 1, "Construction" => 3 + 2, "InternalMass" => 4, "InternalMassDefinition" => 4 }
    expected_num_new_objects = { "Material" => 1, "Construction" => 3 + 2, "InternalMass" => 4, "InternalMassDefinition" => 4 }
    ceiling_ins_r = 0.23495 / 0.1168615354327202
    ceiling_plywood_r = 0.01905 / 0.1154577
    ceiling_mass_r = 0.015875 / 0.1154577
    ceiling_carpet_r = 0.0127 / 0.0433443509615385
