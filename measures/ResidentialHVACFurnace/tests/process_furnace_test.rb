...
class ProcessFurnaceTest < MiniTest::Test
  ...
  def test_new_construction_afue_1_elec
    ...
    expected_values = { "Efficiency" => 1, "NominalCapacity" => 2 * 5861.42, "MaximumSupplyAirTemperature" => 48.88, "FuelType" => Constants.FuelTypeElectric, "hvac_priority" => 1 }
    _test_measure("SFD_2000sqft_2story_SL_UA_Denver.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 3)
  end
  ...
  def test_retrofit_replace_central_air_conditioner
    ...
    expected_num_new_objects = { "AirLoopHVACUnitarySystem" => 1, "AirLoopHVAC" => 1, "CoilHeatingGas" => 1, "FanOnOff" => 1, "AirTerminalSingleDuctConstantVolumeNoReheat" => 2, "CoilCoolingDXSingleSpeed" => 1 }
    expected_values = { "Efficiency" => 0.78, "MaximumSupplyAirTemperature" => 48.88, "FuelType" => Constants.FuelTypeGas, "hvac_priority" => 1 }
  ...
  def test_retrofit_replace_central_air_conditioner2
    ...
    expected_num_new_objects = { "AirLoopHVACUnitarySystem" => 1, "AirLoopHVAC" => 1, "CoilHeatingGas" => 1, "FanOnOff" => 1, "AirTerminalSingleDuctConstantVolumeNoReheat" => 2, "CoilCoolingDXMultiSpeed" => 1, "CoilCoolingDXMultiSpeedStageData" => 2, "UnitarySystemPerformanceMultispeed" => 1 }
    expected_values = { "Efficiency" => 0.78, "MaximumSupplyAirTemperature" => 48.88, "FuelType" => Constants.FuelTypeGas, "hvac_priority" => 1 }
  ...
  def test_retrofit_replace_boiler_central_air_conditioner
    args_hash = {}
    expected_num_del_objects = { "AirLoopHVACUnitarySystem" => 1, "AirLoopHVAC" => 1, "FanOnOff" => 1, "AirTerminalSingleDuctConstantVolumeNoReheat" => 2, "CoilCoolingDXSingleSpeed" => 1, "PlantLoop" => 1, "BoilerHotWater" => 1, "CoilHeatingWaterBaseboard" => 2, "PumpVariableSpeed" => 1, "ZoneHVACBaseboardConvectiveWater" => 2, "SetpointManagerScheduled" => 1 }
    expected_num_new_objects = { "AirLoopHVACUnitarySystem" => 1, "AirLoopHVAC" => 1, "CoilHeatingGas" => 1, "FanOnOff" => 1, "AirTerminalSingleDuctConstantVolumeNoReheat" => 2, "CoilCoolingDXSingleSpeed" => 1 }
    expected_values = { "Efficiency" => 0.78, "MaximumSupplyAirTemperature" => 48.88, "FuelType" => Constants.FuelTypeGas, "hvac_priority" => 1 }
  ...
  def test_single_family_attached_new_construction
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = { "AirLoopHVACUnitarySystem" => num_units, "AirLoopHVAC" => num_units, "CoilHeatingGas" => num_units, "FanOnOff" => num_units, "AirTerminalSingleDuctConstantVolumeNoReheat" => num_units * 2 }
    expected_values = { "Efficiency" => 0.78, "MaximumSupplyAirTemperature" => 48.88, "FuelType" => Constants.FuelTypeGas, "hvac_priority" => 1 }
