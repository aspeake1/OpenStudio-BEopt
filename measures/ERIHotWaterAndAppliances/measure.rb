...
class ERIHotWaterAndAppliances < OpenStudio::Measure::ModelMeasure
    ...
    def run(model, runner, user_arguments)
        ...
        units.each do |unit|
          ...
          cw_space = Geometry.get_space_from_location(unit.spaces, Constants.Auto, location_hierarchy)
          ...
          cd_space = Geometry.get_space_from_location(unit.spaces, Constants.Auto, location_hierarchy)
          ...
          dw_space = Geometry.get_space_from_location(unit.spaces, Constants.Auto, location_hierarchy)
          ...
          fridge_space = Geometry.get_space_from_location(unit.spaces, Constants.Auto, location_hierarchy)
          ...
          cook_space = Geometry.get_space_from_location(unit.spaces, Constants.Auto, location_hierarchy)
          ...
          fx_space = Geometry.get_space_from_location(unit.spaces, Constants.Auto, location_hierarchy)
          ...
          dist_pump_space = Geometry.get_space_from_location(unit.spaces, Constants.Auto, location_hierarchy)
