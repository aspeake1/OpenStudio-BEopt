...
class CreateResidentialSingleFamilyAttachedGeometryTest < MiniTest::Test
  ...
  def test_argument_warning_odd_and_rear_units
    ...
    expected_values = {"FinishedFloorArea"=>900*8, "FinishedBasementHeight"=>8, "UnfinishedAtticHeight"=>21.21, "UnfinishedAtticFloorArea"=>900*8, "BuildingHeight"=>8+21.21, "NumZonesRepresented"=>9-1, "NumAdiabaticSurfaces"=>0}
  ...
  def test_two_story_fourplex_front_units_gable
    ...
    expected_values = {"FinishedFloorArea"=>900*4, "FinishedBasementHeight"=>8, "FinishedBasementFloorArea"=>300*4, "UnfinishedAtticHeight"=>6.12, "UnfinishedAtticFloorArea"=>300*4, "BuildingHeight"=>8+8+8+6.12, "NumZonesRepresented"=>4+4, "NumAdiabaticSurfaces"=>0}
  ...
  def test_ufbasement
    ...
    expected_values = {"FinishedFloorArea"=>900*4, "UnfinishedBasementHeight"=>8, "UnfinishedBasementFloorArea"=>900*4, "UnfinishedAtticHeight"=>10.61, "UnfinishedAtticFloorArea"=>900*4, "BuildingHeight"=>8+8+10.61, "NumZonesRepresented"=>4, "NumAdiabaticSurfaces"=>0}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_crawl
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>4, "Surface"=>50, "ThermalZone"=>4+1+1, "Space"=>4+1+1, "SpaceType"=>3}
    expected_values = {"FinishedFloorArea"=>900*4, "CrawlspaceHeight"=>3, "CrawlspaceFloorArea"=>900*4, "UnfinishedAtticHeight"=>10.61, "UnfinishedAtticFloorArea"=>900*4, "BuildingHeight"=>3+8+10.61, "NumZonesRepresented"=>4, "NumAdiabaticSurfaces"=>0}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_zone_mult_front_units_only
    ...
    expected_values = {"FinishedFloorArea"=>900*3, "UnfinishedAtticHeight"=>10.61, "UnfinishedAtticFloorArea"=>900*8, "BuildingHeight"=>8+10.61, "NumZonesRepresented"=>8, "NumAdiabaticSurfaces"=>7}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_zone_mult_with_rear_units
    ...
    expected_values = {"FinishedFloorArea"=>900*6, "UnfinishedAtticHeight"=>21.21, "UnfinishedAtticFloorArea"=>900*8, "BuildingHeight"=>8+21.21, "NumZonesRepresented"=>8, "NumAdiabaticSurfaces"=>6}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_zone_mult_with_two_stories
    ...
    expected_values = {"FinishedFloorArea"=>900*6, "UnfinishedAtticHeight"=>7.5, "UnfinishedAtticFloorArea"=>8*450, "BuildingHeight"=>8+8+7.5, "NumZonesRepresented"=>8, "NumAdiabaticSurfaces"=>10}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_fourplex_finished_hip_roof
    ...
    expected_values = {"FinishedFloorArea"=>900*4, "FinishedAtticHeight"=>7.5, "FinishedAtticFloorArea"=>450*4, "BuildingHeight"=>8+7.5, "NumZonesRepresented"=>4, "NumAdiabaticSurfaces"=>0}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_fourplex_gable_roof_aspect_ratio_half
    ...
    expected_values = {"FinishedFloorArea"=>900*4, "UnfinishedAtticHeight"=>10.61, "UnfinishedAtticFloorArea"=>900*4, "BuildingHeight"=>8+10.61, "NumZonesRepresented"=>4, "NumAdiabaticSurfaces"=>0}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_fourplex_hip_roof_aspect_ratio_half_offset
    ...
    expected_values = {"FinishedFloorArea"=>900*4, "UnfinishedAtticHeight"=>5.30, "UnfinishedAtticFloorArea"=>900*4, "BuildingHeight"=>8+5.30, "NumZonesRepresented"=>4, "NumAdiabaticSurfaces"=>0}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
  ...
  def test_shared_building_facades
    ...
    expected_num_del_objects = {}
    expected_num_new_objects = {"BuildingUnit"=>4, "Surface"=>80, "ThermalZone"=>2*4+1, "Space"=>(2+1)*4+1, "SpaceType"=>3}
    expected_values = {"FinishedFloorArea"=>900*4, "FinishedBasementHeight"=>8, "FinishedBasementFloorArea"=>300*4, "UnfinishedAtticHeight"=>6.12, "UnfinishedAtticFloorArea"=>300*4, "BuildingHeight"=>8+8+8+6.12, "NumZonesRepresented"=>4+4, "NumAdiabaticSurfaces"=>13}
    _test_measure(nil, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__)
  end
