...
class ResidentialClothesDryerTest < MiniTest::Test
  ...
  def test_single_family_attached_new_construction
    ...
    expected_values = {"Annual_kwh"=>4104.77, "Annual_therm"=>0, "Location"=>args_hash["location"]}
  ...
  def test_single_family_attached_new_construction_finished_basement
    ...
    expected_values = {"Annual_kwh"=>1026.19, "Annual_therm"=>0, "Location"=>args_hash["location"]}
