...
class ProcessBoilerElectricTest < MiniTest::Test
  ...
  def test_retrofit_replace_ashp
    ...
    expected_num_new_objects = {"BoilerHotWater"=>1, "ZoneHVACBaseboardConvectiveWater"=>2, "PlantLoop"=>1, "CoilHeatingWaterBaseboard"=>2, "SetpointManagerScheduled"=>1, "PumpVariableSpeed"=>1}
    expected_values = {"Efficiency"=>1.0, "FuelType"=>Constants.FuelTypeElectric, "hvac_priority"=>1}
    _test_measure("SFD_2000sqft_2story_FB_UA_Denver_ASHP.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 5)
  end  
  ...
  def test_retrofit_replace_ashp2
    ...
    expected_num_new_objects = {"BoilerHotWater"=>1, "ZoneHVACBaseboardConvectiveWater"=>2, "PlantLoop"=>1, "CoilHeatingWaterBaseboard"=>2, "SetpointManagerScheduled"=>1, "PumpVariableSpeed"=>1}
    expected_values = {"Efficiency"=>1.0, "FuelType"=>Constants.FuelTypeElectric, "hvac_priority"=>1}
    _test_measure("SFD_2000sqft_2story_FB_UA_Denver_ASHP2.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 5)
  end  
  ...
  def test_retrofit_replace_boiler
    ...
    expected_num_new_objects = {"BoilerHotWater"=>1, "ZoneHVACBaseboardConvectiveWater"=>2, "PlantLoop"=>1, "CoilHeatingWaterBaseboard"=>2, "SetpointManagerScheduled"=>1, "PumpVariableSpeed"=>1}
    expected_values = {"Efficiency"=>1.0, "FuelType"=>Constants.FuelTypeElectric, "hvac_priority"=>1}
    _test_measure("SFD_2000sqft_2story_FB_UA_Denver_Boiler.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 6)
  end
  ...
  def test_multifamily_new_construction
    ...
    # Retrofit
    expected_num_del_objects = expected_num_new_objects
    model = _test_measure(model, args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, num_units*4)
  end  
