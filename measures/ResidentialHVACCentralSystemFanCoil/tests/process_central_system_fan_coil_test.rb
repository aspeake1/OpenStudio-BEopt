...
class ProcessCentralSystemFanCoilTest < MiniTest::Test
  ...
  def test_retrofit_replace_central_system_fan_coil
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_Central_System_Fan_Coil.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 12)
  end
  
  def test_retrofit_replace_central_system_boiler_baseboards
    num_units = 4
    args_hash = {}
    expected_num_del_objects = {"PlantLoop"=>1, "PumpVariableSpeed"=>1, "BoilerHotWater"=>1, "CoilHeatingWaterBaseboard"=>num_units, "ZoneHVACBaseboardConvectiveWater"=>num_units}
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_Central_System_Boiler_Baseboards.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 11)
  end

  def test_retrofit_replace_central_system_ptac
    num_units = 4
    args_hash = {}
    expected_num_del_objects = {"PlantLoop"=>1, "PumpVariableSpeed"=>1, "BoilerHotWater"=>1, "ControllerWaterCoil"=>num_units, "CoilHeatingWater"=>num_units, "FanConstantVolume"=>num_units, "CoilCoolingDXSingleSpeed"=>num_units, "ZoneHVACPackagedTerminalAirConditioner"=>num_units}
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_Central_System_PTAC.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 11)
  end
  ...
  def test_retrofit_replace_furnace_heating_and_cooling
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_Furnace.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 14)
  end
  ...
  def test_retrofit_replace_furnace_cooling_only
    ...
    expected_num_new_objects = {"PlantLoop"=>1, "PumpVariableSpeed"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>num_units, "CoilCoolingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units, "CoilHeatingElectric"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_Furnace.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 5)
  end
  ...
  def test_retrofit_replace_electric_baseboard
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_ElectricBaseboard.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 10)
  end
  ...
  def test_retrofit_replace_ashp
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_ASHP.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 14)
  end
  ...
  def test_retrofit_replace_mshp
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_MSHP.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 14)
  end
  
  def test_retrofit_replace_boiler
    num_units = 4
    args_hash = {}
    expected_num_del_objects = {"PlantLoop"=>num_units, "BoilerHotWater"=>num_units, "CoilHeatingWaterBaseboard"=>num_units, "PumpVariableSpeed"=>num_units, "ZoneHVACBaseboardConvectiveWater"=>num_units}
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_Boiler.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 14)
  end
  ...
  def test_retrofit_replace_unit_heater
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_UnitHeater.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 10)
  end
  ...
  def test_retrofit_replace_room_air_conditioner
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_RoomAC.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 10)
  end
  ...
  def test_retrofit_replace_gshp_vert_bore
    ...
    expected_num_new_objects = {"PlantLoop"=>2, "PumpVariableSpeed"=>2, "BoilerHotWater"=>1, "ChillerElectricEIR"=>1, "ControllerWaterCoil"=>2*num_units, "CoilCoolingWater"=>num_units, "CoilHeatingWater"=>num_units, "FanOnOff"=>num_units, "ZoneHVACFourPipeFanCoil"=>num_units}
    expected_values = {}
    _test_measure("SFA_4units_1story_SL_UA_3Beds_2Baths_Denver_GSHPVertBore.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, 18)
  end
