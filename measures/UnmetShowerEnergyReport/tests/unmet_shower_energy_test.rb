...
class UnmetShowerEnergyReportTest < MiniTest::Test
  ...
  def test_functionality
    ...
    expected_values = {}
    _test_measure("SFD_Successful_EnergyPlus_Run_TMY_Fxitures_PV.osm", args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, __method__, "USA_CO_Denver_Intl_AP_725650_TMY3.epw", 3, 0, 3)
  end
