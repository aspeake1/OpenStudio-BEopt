...
class ProcessSingleSpeedAirSourceHeatPumpTest < MiniTest::Test  
  ...
  def test_new_construction_fbsmt_seer_13_7pt7_hspf_80_dse
    ...
    args_hash["dse"] = "0.8"
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>2, "AirLoopHVAC"=>2, "CoilCoolingDXSingleSpeed"=>1, "FanOnOff"=>2, "AirTerminalSingleDuctConstantVolumeNoReheat"=>4, "CoilHeatingElectric"=>1, "CoilHeatingDXSingleSpeed"=>1}
  ...
  def test_single_family_attached_new_construction
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>num_units*2, "AirLoopHVAC"=>num_units*2, "CoilCoolingDXSingleSpeed"=>num_units, "FanOnOff"=>num_units*2, "AirTerminalSingleDuctConstantVolumeNoReheat"=>num_units*4, "CoilHeatingElectric"=>num_units, "CoilHeatingDXSingleSpeed"=>num_units}
    expected_values = {"CoolingCOP"=>4.07, "HeatingCOP"=>3.33, "MaximumSupplyAirTemperature"=>76.66}
