...
class ProcessSingleSpeedAirSourceHeatPumpTest < MiniTest::Test  
  ...
  def test_new_construction_fbsmt_seer_13_7pt7_hspf_80_dse
    ...
    args_hash["dse"] = "0.8"
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>2, "AirLoopHVAC"=>2, "CoilCoolingDXSingleSpeed"=>1, "FanOnOff"=>2, "AirTerminalSingleDuctUncontrolled"=>4, "CoilHeatingElectric"=>1, "CoilHeatingDXSingleSpeed"=>1}
    expected_values = {"CoolingCOP"=>4.07*0.8, "HeatingCOP"=>3.33*0.8, "CoolingNominalCapacity"=>10550.55, "HeatingNominalCapacity"=>10550.55, "SuppNominalCapacity"=>5861.42, "MaximumSupplyAirTemperature"=>76.66}
  ...
  def test_single_family_attached_new_construction
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>num_units*2, "AirLoopHVAC"=>num_units*2, "CoilCoolingDXSingleSpeed"=>num_units, "FanOnOff"=>num_units*2, "AirTerminalSingleDuctUncontrolled"=>num_units*4, "CoilHeatingElectric"=>num_units, "CoilHeatingDXSingleSpeed"=>num_units}
    expected_values = {"CoolingCOP"=>4.07, "HeatingCOP"=>3.33, "MaximumSupplyAirTemperature"=>76.66}
  ...
  def test_multifamily_new_construction
    ...
    args_hash = {}
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>num_units*2, "AirLoopHVAC"=>num_units*2, "CoilCoolingDXSingleSpeed"=>num_units, "FanOnOff"=>num_units*2, "AirTerminalSingleDuctUncontrolled"=>num_units*2, "CoilHeatingElectric"=>num_units, "CoilHeatingDXSingleSpeed"=>num_units}
    expected_values = {"CoolingCOP"=>4.07, "HeatingCOP"=>3.33, "MaximumSupplyAirTemperature"=>76.66}
