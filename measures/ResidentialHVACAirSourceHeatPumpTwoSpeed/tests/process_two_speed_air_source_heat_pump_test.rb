...
class ProcessTwoSpeedAirSourceHeatPumpTest < MiniTest::Test  
  ...
  def test_new_construction_seer_16_8pt6_hspf
    ...
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>2, "AirLoopHVAC"=>2, "CoilCoolingDXMultiSpeed"=>1, "FanOnOff"=>2, "AirTerminalSingleDuctUncontrolled"=>2, "CoilHeatingElectric"=>1, "CoilHeatingDXMultiSpeed"=>1, "CoilCoolingDXMultiSpeedStageData"=>2, "CoilHeatingDXMultiSpeedStageData"=>2, "UnitarySystemPerformanceMultispeed"=>1}
  ...
  def test_new_construction_fbsmt_seer_16_8pt6_hspf_80_dse
    ...
    args_hash["dse"] = "0.8"
    expected_num_del_objects = {}
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>2, "AirLoopHVAC"=>2, "CoilCoolingDXMultiSpeed"=>1, "FanOnOff"=>2, "AirTerminalSingleDuctUncontrolled"=>4, "CoilHeatingElectric"=>1, "CoilHeatingDXMultiSpeed"=>1, "CoilCoolingDXMultiSpeedStageData"=>2, "CoilHeatingDXMultiSpeedStageData"=>2, "UnitarySystemPerformanceMultispeed"=>1}
  ...
  def test_retrofit_replace_furnace_central_air_conditioner
    ...
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>2, "AirLoopHVAC"=>2, "CoilCoolingDXMultiSpeed"=>1, "FanOnOff"=>2, "AirTerminalSingleDuctUncontrolled"=>4, "CoilHeatingElectric"=>1, "CoilHeatingDXMultiSpeed"=>1, "CoilCoolingDXMultiSpeedStageData"=>2, "CoilHeatingDXMultiSpeedStageData"=>2, "UnitarySystemPerformanceMultispeed"=>1}
    expected_values = {"CoolingCOP"=>[4.16, 3.69], "HeatingCOP"=>[3.97, 3.43], "MaximumSupplyAirTemperature"=>76.66, "hvac_priority"=>2}
