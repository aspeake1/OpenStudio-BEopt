...
class ProcessTwoSpeedAirSourceHeatPumpTest < MiniTest::Test
  ...
  def test_retrofit_replace_central_system_fan_coil
    ...
    expected_num_new_objects = {"AirLoopHVACUnitarySystem"=>num_units, "AirLoopHVAC"=>num_units, "CoilCoolingDXMultiSpeed"=>num_units, "FanOnOff"=>num_units, "AirTerminalSingleDuctConstantVolumeNoReheat"=>num_units, "CoilHeatingElectric"=>num_units, "CoilHeatingDXMultiSpeed"=>num_units, "CoilCoolingDXMultiSpeedStageData"=>num_units*2, "CoilHeatingDXMultiSpeedStageData"=>num_units*2, "UnitarySystemPerformanceMultispeed"=>num_units}
    expected_values = {"CoolingCOP"=>[4.16, 3.69], "HeatingCOP"=>[3.97, 3.43], "MaximumSupplyAirTemperature"=>76.66, "hvac_priority"=>1}
