...
class ProcessHVACSizingTest < MiniTest::Test
  ...
  def test_equip_ASHP_one_speed_autosize
    ...
    expected_num_new_objects = {}
    expected_values = {
            'AirLoopHVAC_Design Supply Air Flow rate {m3/s}' => UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Cooling Operation {m3/s}' => UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Heating Operation {m3/s}' => UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'Coil:Heating:DX:SingleSpeed_Rated Total Heating Capacity {W}' => 9430.05384169,
            'Coil:Heating:DX:SingleSpeed_Rated Air Flow Rate {m3/s}' => UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            ...
            'Coil:Cooling:DX:SingleSpeed_Rated Air Flow Rate {m3/s}' => UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'Fan:OnOff_Living_Maximum Flow Rate {m3/s}' => UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Living_Maximum Flow Rate {m3/s}' => 0.9547057822736946 * UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Basement_Maximum Flow Rate {m3/s}' => 0.04529421772630538* UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
                      }
  ...
  def test_equip_ASHP_one_speed_autosize_min_temp
    ...
    expected_values = {
            ...
            'Fan:OnOff_Living_Maximum Flow Rate {m3/s}' => UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Living_Maximum Flow Rate {m3/s}' => 0.9547057822736946 * UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Basement_Maximum Flow Rate {m3/s}' => 0.04529421772630537 * UnitConversions.convert(2.637699588080771 * 400.0, "cfm", "m^3/s"),
                      }
  ...
  def test_equip_ASHP_one_speed_autosize_for_max_load_min_temp
    ...
    expected_num_new_objects = {}
    expected_values = {
            'AirLoopHVAC_Design Supply Air Flow rate {m3/s}' => UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Cooling Operation {m3/s}' => UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Heating Operation {m3/s}' => UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
            'Coil:Heating:DX:SingleSpeed_Rated Total Heating Capacity {W}' => 25289.2367851,
            'Coil:Heating:DX:SingleSpeed_Rated Air Flow Rate {m3/s}' => UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
            'Coil:Heating:Electric_Nominal Capacity {W}' => 27701.2991485,
            'Coil:Cooling:DX:SingleSpeed_Rated Total Cooling Capacity {W}' => 25289.2367851,
            'Coil:Cooling:DX:SingleSpeed_Rated Air Flow Rate {m3/s}' => UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
            'Fan:OnOff_Living_Maximum Flow Rate {m3/s}' => UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Living_Maximum Flow Rate {m3/s}' => 0.9547057822736946 * UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Basement_Maximum Flow Rate {m3/s}' => 0.04529421772630537 * UnitConversions.convert(7.128527199166287 * 400.0, "cfm", "m^3/s"),
                      }
  ...
  def test_equip_ASHP_one_speed_fixedsize
    ...
    expected_num_new_objects = {}
    expected_values = {
            'AirLoopHVAC_Design Supply Air Flow rate {m3/s}' => UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Cooling Operation {m3/s}' => UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Heating Operation {m3/s}' => UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'Coil:Heating:DX:SingleSpeed_Rated Total Heating Capacity {W}' => 17586.0,
            'Coil:Heating:DX:SingleSpeed_Rated Air Flow Rate {m3/s}' => UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'Coil:Heating:Electric_Nominal Capacity {W}' => 14655.0,
            'Coil:Cooling:DX:SingleSpeed_Rated Total Cooling Capacity {W}' => 17586.0,
            'Coil:Cooling:DX:SingleSpeed_Rated Air Flow Rate {m3/s}' => UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'Fan:OnOff_Living_Maximum Flow Rate {m3/s}' => UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Living_Maximum Flow Rate {m3/s}' => 0.9151292784503617 * UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Basement_Maximum Flow Rate {m3/s}' => 0.08487072154963825 * UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
                      }
  ...
  def test_equip_unit_heater_ac_one_speed_autosize
    ...
    expected_num_new_objects = {}
    expected_values = {
            'AirLoopHVAC_Design Supply Air Flow rate {m3/s}' => UnitConversions.convert(2.2860222317000884 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Cooling Operation {m3/s}' => UnitConversions.convert(2.2860222317000884 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Heating Operation {m3/s}' => 0.610228,
            'Coil:Heating:Fuel_Nominal Capacity {W}' => 12012.1,
            ...
            'Fan:OnOff_Living_Maximum Flow Rate {m3/s}' => 0.610228+UnitConversions.convert(2.2860222317000884 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Living_Maximum Flow Rate {m3/s}' => 0.8964577715383649 * UnitConversions.convert(2.2860222317000884 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Basement_Maximum Flow Rate {m3/s}' => 0.10354222846163505 * UnitConversions.convert(2.2860222317000884 * 400.0, "cfm", "m^3/s"),
                      }
  ...
  def test_equip_unit_heater_ac_one_speed_fixedsize
    ...
    expected_values = {
            ...
            'Fan:OnOff_Living_Maximum Flow Rate {m3/s}' => 0.446462+UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Living_Maximum Flow Rate {m3/s}' => 0.8585487974172697 * UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
            'AirTerminal:SingleDuct:Uncontrolled_Basement_Maximum Flow Rate {m3/s}' => 0.14145120258273025 * UnitConversions.convert(5.0 * 400.0, "cfm", "m^3/s"),
                      }
  ...
  def test_equip_gas_furnace_and_ac_one_speed_autosize
    ...
    expected_values = {
            'AirLoopHVAC_Design Supply Air Flow rate {m3/s}' => 0.963903000253,
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Cooling Operation {m3/s}' => UnitConversions.convert(2.28602223170009 * 400.0, "cfm", "m^3/s"),
            'AirLoopHVAC:UnitarySystem_Supply Air Flow Rate During Heating Operation {m3/s}' => 0.963903000253,
            'Coil:Heating:Fuel_Nominal Capacity {W}' => 27112.097878,
            'Coil:Cooling:DX:SingleSpeed_Rated Total Cooling Capacity {W}' => 8172.77025244,
            'Coil:Cooling:DX:SingleSpeed_Rated Air Flow Rate {m3/s}' => 0.423414437383,
