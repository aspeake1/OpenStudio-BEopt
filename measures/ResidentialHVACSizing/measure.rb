    ...
    gains.each do |gain|
        ...
        if sched.is_a? OpenStudio::Model::ScheduleRuleset
            ...
            if gain.name.to_s.start_with?(Constants.ObjectNameShower)
                ...
                max_mult = 1.15 * 1.04
            elsif gain.name.to_s.start_with?(Constants.ObjectNameClothesDryer(Constants.FuelTypeElectric)) or gain.name.to_s.start_with?(Constants.ObjectNameClothesDryer(Constants.FuelTypeGas)) or gain.name.to_s.start_with?(Constants.ObjectNameClothesDryer(Constants.FuelTypePropane))
